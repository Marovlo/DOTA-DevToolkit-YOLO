...
if __name__ == '__main__':
    ...
    dota2Darknet(f'/data/hatim/zzl/1dota/{split_size}trainsplit/images',#train images
                 f'/data/hatim/zzl/1dota/{split_size}trainsplit/labelTxt',# train dota label
                 f'/data/hatim/zzl/1dota/{split_size}trainsplit/yolo_label',
                 util.classnames_v1_5)

    dota2Darknet(f'/data/hatim/zzl/1dota/{split_size}valsplit/images',  # val images
                 f'/data/hatim/zzl/1dota/{split_size}valsplit/labelTxt',  # val dota label
                 f'/data/hatim/zzl/1dota/{split_size}valsplit/yolo_label',
                 util.classnames_v1_5)
